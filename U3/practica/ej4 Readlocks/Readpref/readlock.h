...
int readlock_init(void); // Devuelve -1 en caso de error 0 caso contrario

int readlock_read(void); // Devuelve -1 en caso de error 0 caso contrario 

int readlock_stopRead(void);

int readlock_write(void); // Devuelve -1 en caso de error 0 caso contrario

int readlock_stopWrite(void);

int readlock_destroy(void);
